...
const Register = () => {
  ...
  return (
    <>
      {success ? (
        <section className=" bg-blue-400 rounded-lg flex flex-col text-2xl font-semibold">
          <h1>Success!</h1>
          <p>
            <a href="#">Sign In</a>
          </p>
        ...
        <section className=" w-full max-w-md min-h-fit flex flex-col justify-start p-4 bg-blue-200 rounded-xl text-blue-900">
          ...
          >
            ...
            <label htmlFor="confirm_pwd" className=" py-2">
              Confirm Password:
              <FontAwesomeIcon
                icon={faCheck}
            ...
            <button
              ...
              className=" border-2 rounded-md my-2 mt-6 p-2 border-white font-semibold disabled:opacity-50"
            >
              Sign Up
            </button>
          </form>
